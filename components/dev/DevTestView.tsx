            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent className="p-4 bg-muted/20">
                  <Image
                    src={`/api/days?width=${device.width}&height=${device.height}`}
                  ...
                  <div className="mt-2 text-[10px] text-muted-foreground break-all font-mono">
                    {`/api/days?width=${device.width}&height=${device.height}`}
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="p-4 bg-muted/20">
                  <Image
                    src={`/api/months?width=${device.width}&height=${device.height}`}
